...
import NewInventoryHeaderShelfA from '../Header/NewInventoryHeaderShelfA.js';
import { Link } from 'react-router-dom';
import axios from 'axios';

class NewInventoryShelfA extends Component {
    constructor(props){
        super(props);
    ...
    render() {
        return (
            <div>
                <NewInventoryHeaderShelfA id={this.props.match.params.id[1]}/>
...
export default NewInventoryShelfA;